...
def display_init()
 ...
 arc.set_style_arc_width(2, lv.PART_MAIN | lv.STATE_DEFAULT)
 arc.set_style_arc_width(4, lv.PART_INDICATOR | lv.STATE_DEFAULT)
 arc.set_style_arc_width(8, lv.PART_KNOB | lv.STATE_DEFAULT)
 arc.set_style_pad_all(3, lv.PART_KNOB | lv.STATE_DEFAULT)
 arc.set_end_angle(200)
 arc.set_size(56, 56)
 arc.set_range(ROT_MIN,ROT_MAX)
 arc.set_value(int(ROT_MIN))
 arc.align(lv.ALIGN_TOP_MID,0,0)
 ...
 ttemp.align(lv.ALIGN_CENTER, 0, 6)
 theating.set_style_text_font(fm, lv.PART_MAIN | lv.STATE_DEFAULT)
 theating.set_style_text_color(bgcolor, lv.PART_MAIN | lv.STATE_DEFAULT)
 theating.set_text(lv.SYMBOL_CHARGE)
 theating.align(lv.ALIGN_TOP_LEFT, 10, 8)
 lv.scr_load(scr)
end
...
tasmota.cmd("BackLog DisplayDimmer 100;SetOption43 1;SetOption98 1;SetOption1 1;SetOption36 5;WebButton1 Heating;WebButton2 Motion;WebButton3 Display;Teleperiod 60;")
